...
function reducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    case 'SELECT': {
      ...
      return {
        ...state,
        selection: on ? state.selection.filter((x) => x !== action.id) : [...state.selection, action.id],
      };
    }
    ...
    case 'CREATE_ACCOUNT':
      return {
        ...state,
        profile: { ...state.profile, phone: action.phone, email: action.email, accountCreated: true, live: true },
